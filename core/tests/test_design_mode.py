"""Design mode hit-test and attachment (TD-3403).

Browser first. The mock returns a scripted node; the crop travels as a
UTF-8 JSON sidecar under TD-1709 caps — not a new wire type.
"""
...
from tstd.protocol import Attachment, DesignHit, parse_daemon_event
