...
# SKILL.md must not drift from the classifier's _STEERING_BASENAMES
# (TD-4502): a SKILL.md under .tst/memory/ would otherwise be indexed
# as a retrievable memory candidate — prompt material the steering
# guard cannot see.
